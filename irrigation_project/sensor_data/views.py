...
model = load('C:/Users/GIGABYTE/irrigation_project/pump_decision_model.joblib')  # Sử dụng joblib
print(type(model))
...
def predict_and_control_pump(temperature, humidity, soil_moisture):
    try:
        ...
        client.publish("pump/control", json.dumps({"pump_status": pump_status}))
